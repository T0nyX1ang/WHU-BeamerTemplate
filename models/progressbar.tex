...
\providecommand{\drawprogressbarh}[7]{
    ...
    \draw[line width=0.8pt, color=#1] (0.05 * #2 + 0.75 / #3 * #2 * #4, 0) -- (0.05 * #2 + 0.75 / #3 * #2 * #5, 0); % extinguish current section by line width
    \begin{scope}[xshift=0.05 * #2 + 0.75 / #3 * #2 * #6, scale=.05]
        \drawflower{5}{#7}
    \end{scope}
}
...
\providecommand{\drawprogressbarv}[7]{
    ...
    \draw[line width=0.8pt, color=#1] (0, -0.05 * #2 - 0.75 / #3 * #2 * #4) -- (0, -0.05 * #2 - 0.75 / #3 * #2 * #5);
    \begin{scope}[yshift=-0.05 * #2 - 0.75 / #3 * #2 * #6, scale=.05]
        \drawflower{5}{#7}
    \end{scope}
